...
def main():
    ...
    feature_detectors = ["sift", "orb", "disk", "superpoint"]
    feature_matchers = ["flann", "snn","smnn", "fginn", "adalam", "lightglue"]
    ...
    for feature_dect in feature_detectors:
        #if feature_dect == "disk": continue
        for feature_mat in feature_matchers:
            feature_detector = feature_dect
            feature_matcher = feature_mat
